# Proposed Knowledge: a differential test can pass with its subject disabled

Status: proposed for knowledge-store-steward review
Classification: internal
Source task: review of PR #163
(`roster/orchestration/test/test_glob_containment.py`), 2026-08-08
Origin revision: `05a9b97` on branch `agent/routing-health-exclude-shadow`,
merged as `9cffcfa`
