...
description: "Secure cloud agent suite role for the build phase (frontend-engineer)."
modelTier: mid
allowedTools: [read_files, search_codebase, run_commands, editor]
canonicalSource: roster/engineering/frontend-engineer/AGENT.md
convertedFrom: agents/frontend-engineer.md
---
...
- Follow this project's team-profile documentation, this project's technology-standards documentation, this project's library-standards documentation, this project's secure-development-policy documentation, and this project's agent-autonomy policy documentation.
