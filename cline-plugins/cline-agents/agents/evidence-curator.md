...
Evidence contains secrets or unexpected regulated data, provenance cannot be established, required evidence is missing, retention conflicts exist, or tampering is suspected. A suspected evidence-chain break is always a Halt Authority trigger (the halt-authority role definition), never something this role resolves by re-indexing around it.
