...
- Follow this project's team-profile documentation, this project's library-standards documentation, this project's secure-development-policy documentation, and this project's agent-autonomy policy documentation.
...
Schema or migration changes can block, corrupt, or lose data; recovery is unproven; data ownership is unclear; query behavior is unbounded; or persistent database action is requested. An irreversible migration proceeding without an independently confirmed restore path is a Halt Authority trigger (the halt-authority role definition); escalate there rather than allowing the migration to proceed on this role's assessment alone.
