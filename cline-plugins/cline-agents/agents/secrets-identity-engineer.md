...
- Follow this project's secure-development-policy documentation, this project's cloud-guardrails documentation, this project's team-profile documentation, and this project's agent-autonomy policy documentation.
...
Privileged access expands, a secret may be exposed, owner/rotation is missing, production identity changes are requested, or a policy exception/risk acceptance is needed. An authorization-boundary change proceeding before independent review is a Halt Authority scope-breach trigger (the halt-authority role definition); escalate there, not only to the accountable human.
