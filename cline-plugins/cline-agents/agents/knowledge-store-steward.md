...
- Agent-proposed `knowledge_steward_handoffs` items, field list and redaction rule per this project's knowledge-use-policy documentation, staged as records via `cadre knowledge propose` in the frontmatter format defined by this project's staged-knowledge-record schema — see Staging and Disposition below
...
- Follow this project's security documentation, this project's operating-principles documentation, this project's team-profile documentation, this project's technology-standards documentation, and this project's agent-autonomy policy documentation.
...
# Shared policy: this project's knowledge-use-policy documentation
...
this project's context-use-policy documentation governs the sibling context store
...
# Shared policy: this project's context-use-policy documentation
...
degree. See this project's knowledge-use-policy documentation for that store's rules; the
...
- **Choose the narrowest scope that works.** `agent` (default) for your own
  ...
  audit trail, it is not access control (this project's context-store security documentation).
- **Reference by handle in handoffs, never in place of a required field.**
  this project's handoff-contracts documentation's `context_handles` list carries
...
# Shared policy: documentation-style.md
...
# Shared policy: workspace-isolation.md
...
partitioning (see this project's knowledge-store security documentation) would silently and
