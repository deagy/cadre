...
Residual risk exceeds policy, evidence is contradictory, control ownership is missing, a critical/high finding remains, or an exception is requested. A doctrine or architecture violation, an evidence-chain break, or a cryptographic downgrade found during this assessment is a Halt Authority trigger (the halt-authority role definition); escalate there in addition to the accountable human Security Lead.
