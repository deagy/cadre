...
Read `roster/shared/knowledge-use-policy.md` and
`roster/shared/context-use-policy.md` before accessing either store. If this
is an installed package without a local `roster/`, resolve those files under
`../../suite/roster/` relative to this skill.
