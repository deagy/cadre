...
- [`hermes-plugins/`](hermes-plugins/) holds the roster rendered as a Hermes skill tree (`skills/cadre/`, generated by `cadre port-hermes-skills`), which `install.sh --runner=hermes` copies into `~/.hermes/skills/`.
...
| [Hermes](https://hermes-agent.nousresearch.com/docs/) | Generated skill tree | [`hermes-plugins/skills/cadre/`](hermes-plugins/) holds one skill per role and workflow plus `cadre-orchestrator`; `install.sh --runner=hermes` copies it to `~/.hermes/skills/cadre/`, and the orchestrator skill dispatches roles through `delegate_task` after selecting them with `cadre select`. See [`docs/INSTALL.md`](docs/INSTALL.md#hermes). |
